...
const features = [
  ...
  {
    title: 'Customizable',
    description: 'Customize this app to fit your needs and preferences.',
    icon: 'icon-2',
  },
  {
    title: 'Analytics',
  ...
  {
    title: 'Secure',
    description: 'Your data is safe and secure with it.',
  },
  {
    title: 'Scalable',
    description: 'Grow your business with it as you scale.',
  },
  {
    title: 'Fast Support',
